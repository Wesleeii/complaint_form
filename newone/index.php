        <?php
            ...
            if(array_key_exists('sub', $_POST)) {
                ...
                if(empty($_POST['meternum'])) {
                    $error[] = "Please enter the meter number";
                }
                if(empty($_POST['plan'])) {
            ...
            if(array_key_exists('log', $_POST)) {
                ...
                if(empty($_POST['email'])) {
                    $errorlog[] = "Please enter your email";
                }
                if(empty($_POST['pword'])) {
                    $errorlog[] = "Please enter your password";
                }

                if(empty($errorlog)) {
                    $clean = array_map('trim', $_POST);
                    $log   = login($conn, $clean);
                    if($log[0]) {
                        $_SESSION['userid'] = $log[1];
                        $a = checkPlan($conn, $_SESSION['userid']);
                        if($a == "Prepaid") {
                        header("Location: prepaidlanding.php");
                        } else {
                            if($a = "Postpaid") {
                                header("Location: postpaidlanding.php");
                            }
                        }
                    } 
                } else {
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="Registration">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                    <label for="plan" class="col-sm-2 control-label">
                                                        Plan</label>
                                                    <div class="col-sm-10">
                                                        <input type="radio" name="plan" required="required" value="Prepaid" />Prepaid
                                                        <input type="radio" name="plan" required="required" value="Postpaid" />Postpaid
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-2">
