<?php
    ...
    if(array_key_exists('submit', $_POST)) {
        $arr = [];
        if(empty($_POST['unit'])) {
            $arr[] = "Please select a unit plan";
        }
        
        if(empty($arr)) {
            $clean = array_map('trim', $_POST);
            insertPayment($conn, $clean, $id);
            $_SESSION['amount'] = $_POST['unit'] * 50;
...
?>
        ...
        <header>
            <div class="container">
                <!--logo-->
                    <div class="logo">
                        <a href="index.php"> <img src="images/b.png" style="height:50px" "width:20px"></a>
                    </div>
                <!--//logo-->
                  <div class="w3layouts-login" id="modal">
                                            ...
                                            <div class="tab-pane active" id="Login">
                                                ...
                                                <div class="form-group">
                                                    <label for="email" class="col-sm-2 control-label">
                                                        Email</label>
                                                    <div class="col-sm-10">
                                                        <input type="email" class="form-control" id="email1" name="email" placeholder="Email" required="required" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1" class="col-sm-2 control-label">
                                                        Password</label>
                                                    <div class="col-sm-10">
                                                        <input type="password" class="form-control" id="exampleInputPassword1" name="pword" placeholder="password" required="required" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <button type="submit" class="submit btn btn-primary btn-sm" name="log">
                                                            Submit</button>
                                            ...
                                            <div class="tab-pane" id="Registration">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="row">
                                                            <div class="col-md-3 col-sm-3 col-xs-3">
                                                                <select class="form-control" name="gender-title">
                                                            ...
                                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                                <input type="text" class="form-control" name="last" placeholder="Last Name" required="required" /><br/>
                                                ...
                                                <div class="form-group">
                                                    <label for="email" class="col-sm-2 control-label">
                                                        Email</label>
                                                    <div class="col-sm-10">
                                                        <input type="email" class="form-control" id="email" name="mail" placeholder="Email" required="required" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="mobile" class="col-sm-2 control-label">
                                                        Mobile</label>
                                                    <div class="col-sm-10">
                                                        <input type="tel" class="form-control" id="mobile" name="phone" placeholder="Mobile" required="required" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                    <label for="meter-num" class="col-sm-2 control-label">
                                                        Meter</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="mobile" name="meternum" placeholder="Meter Number" required="required" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <button type="submit" class="submit btn btn-primary btn-sm" name="sub">
                        ...
                        <div class="callbacks_container">
                          <ul class="rslides" id="slider">		       
                             <li>
                                 <div class="banner1">
                                    <div class="caption">
                                        <h3><span>Recharge From</span> Your Comfort Zone</h3>
                             ...
                             <li>
                                 <div class="banner2">
                                    <div class="caption">
                                        <h3><span>Very Easy</span> Way To Pay Your Bills</h3>
                                        <p><a href="#mobilew3layouts" class="scroll">Recharge now</a></p>
                             ...
                             <li>
                                 <div class="banner3">
                                    <div class="caption">
                                        <h3><span>All You </span> Need Is To Register</h3>
            ...
            <div class="categories-section main-grid-border" id="mobilew3layouts">
                <div class="container">
                    <div class="category-list">
                        ...
                        <ul class="tabs-menu">
                            <h1><?php $a = checkPlan($conn, $id); echo $a; ?></h1><br/>
<!--
                         ...
                         <div class="tab-grids">
                            <div id="tab1" class="tab-grid">  
                                ...
                                <ol>							
                                    <li>
                                        <h2>Meter Number:
                                        <?php $b = checkMeterNum($conn, $id); echo $b; ?></h2>
                                        <hr/>
                                        <h2>Location:
                                        <?php $c = checkLocation($conn, $id); echo $c; ?></h2>
                                        <hr/>
                                        
                                        
                                        <!--<input type="tel" id="tel" name="tel" pattern="\d{10}" placeholder="Enter Meter Number" required="required" />-->
                                    ...
                                    <li>
                                        ...
                                        <select name="unit" class="selectpicker show-tick" data-live-search="true" required="required" >
                                          <option data-tokens="Select a plan">Select a plan</option>
                                          <option value="200" data-tokens="200 Units">200 Units (₦10000)</option>
                                          <option value="500" data-tokens="500 Units">500 Units (₦25000)</option>
                                          <option value="1000" data-tokens="1000 Units">1000 Units (₦50000)</option>
                                          <option value="2000" data-tokens="2000 Units">2000 Units (₦100000)</option>
                                          <option value="3000" data-tokens="3000 Units">3000 Units (₦150000)</option>
                                          <option value="5000" data-tokens="5000 Units">5000 Units (₦250000)</option>
                                          <option value="10000" data-tokens="1000 Units">10000 Units (₦500000)</option>
                                        </select>
                                        </div>
                                    </li>
<!--
                                    <li>
                                        ...
                                        <select class="selectpicker show-tick" data-live-search="true" required="required" >
                                          <option data-tokens="Select Circle">Select Area</option>
                                          <option data-tokens="Ikeja">Ikeja</option>
                                          <option data-tokens="Agege">Agege</option>
                                          <option data-tokens="Ikoyi">Ikoyi</option>
                                          <option data-tokens="Ikorodu">Ikorodu</option>
                                          <option data-tokens="Mile 2">Mile 2</option>
                                          <option data-tokens="Assam">Ojota</option>
                                          <option data-tokens="Ogba">Ogba</option>
                                          <option data-tokens="Lekki">Lekki</option>
                                          <option data-tokens="V.I">V.I</option>
                                          <option data-tokens="Iputa">Iputa</option>
                                        </select>
                                        </div>
...
-->
                                    ...
                                    <li>
                                        <input name="submit" type="submit" class="submit" value="Recharge Now" />
                                    </li>
                                </ol>
                                </form>	
                            ...
                            <div id="tab2" class="tab-grid">
                                      <div class="login-form">
                                <form action="pay.php" method="post" id="signup">
                                <ol>							
                                    <li>
                                        <h4>Enter your Meter number</h4>
                                        <input type="tel" id="tel" name="tel" pattern="\d{10}" placeholder="Enter Meter Number" required />
                                        <p class="validation01">
                                            <span class="invalid">Please enter a valid mobile number</span>
                                            <span class="valid">That's what we wanted!</span>
                                        </p>
                                    ...
                                    <li>
                                        ...
                                        <select class="selectpicker show-tick" data-live-search="true">
                                         <option data-tokens="Select Operator">Select Operator</option>
                                          <option data-tokens="Airtel">Operator 1</option>
                                          <option data-tokens="Aircel">Operator 2</option>
                                          <option data-tokens="BSNL">Operator 3</option>
                                          <option data-tokens="Tata Docomo">Operator 4</option>
                                          <option data-tokens="Reliance GSM">Operator 5</option>
                                          <option data-tokens="Reliance CDMA">Operator 6</option>
                                          <option data-tokens="Telenor">Operator 7</option>
                                        </select>
                                        </div>
                                    </li>
                                    <li>
        ...
        <footer>
            <div class="container-fluid">
                <div class="w3-agile-footer-top-at">
                    <div class="col-md-6 agileits-amet-sed">
                        <h4>Company</h4>
            ...
            <!--<div class="w3l-footer-bottom">
                <div class="container-fluid">
                    <div class="col-md-4 w3-footer-logo">
                        <h2><a href="index.html">ELECTRIFY</a></h2>
                    </div>
