...
<header>
	<div class="container">
		<!--logo-->
			<div class="logo">
				<a href="index.html"> <img src="images/b.png" style="height:50px" "width:20px"></a>
			</div>
		<!--//logo-->
...
<!--											<button class="submit" name="sub"><span>Make a payment <i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></button>-->
										</div>
									</section>
								</form>
<!-- credit-card -->
