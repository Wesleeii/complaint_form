<?php
    ...
    if(array_key_exists('sub', $_POST)) {
        if(empty($_POST['name'])) {
            $error[] = "Please enter the card name";
        }
        if(empty($_POST['number'])) {
            $error[] = "Please enter the card number";
        }
        if(empty($_POST['security-code'])) {
            $error[] = "Please enter the three digit CVV";
        }
        if(empty($_POST['expiration-month-and-year'])) {
            $error[] = "Please enter the expiration month and year";
        }
...
<header>
	<div class="container">
		<!--logo-->
			<div class="logo">
				<a href="prepaidlanding.php"> <img src="images/b.png" style="height:50px" "width:20px"></a>
			</div>
		<!--//logo-->
...
<!-- breadcrumbs -->
	...
	<!--Horizontal Tab-->
        <?php if(isset($_SESSION['amount'])) {
                echo "<h2>Payment Amount: " . $amount . "</h2><br/>";
            }
        ?>
...
<!--                                            <input type="submit" name="sub" value="Make a Payment" style="color:black">-->
											<button class="submit" name="sub">Make a payment <i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></button>
										</div>
									</section>
								</form>
<!-- credit-card -->
                    ...
                    <div class="vertical_post">
									<form>
										...
										<div class="swit-radio">								
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio" checked=""><i></i>First Bank</label> </div></div>
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i> Wema Bank</label> </div></div>
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i>GT Bank</label> </div></div>	
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i>Zenith Bank</label> </div></div>	
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i>Diamond Bank</label> </div></div>		
											<div class="clearfix"></div>
										</div>
